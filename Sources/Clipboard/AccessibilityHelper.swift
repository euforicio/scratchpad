...
enum AccessibilityHelper {
    ...
    static func requestPermission() {
        ...
        alert.informativeText = String(localized: "accessibility.alert.message", defaultValue: "Scratchpad needs accessibility access to paste into other apps. The item has been copied to your clipboard – you can paste manually with ⌘V.")
