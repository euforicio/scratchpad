...
class SyntaxHighlightCoordinator: NSObject, NSTextViewDelegate {
    ...
    private static let highlightQueue = DispatchQueue(label: "Scratchpad.SyntaxHighlight", qos: .userInitiated)
    ...
    static let linkURLKey = NSAttributedString.Key("ScratchpadLinkURL")
