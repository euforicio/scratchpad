...
enum SyntaxThemeRegistry {
    static let themes: [SyntaxThemeDefinition] = [
        ...
        .init(id: "scratchpad", displayName: "Scratchpad", darkResource: "scratchpad-dark.min", lightResource: "scratchpad-light.min"),
    ...
    static func cssResource(for themeId: String, isDark: Bool) -> String {
        let def = themes.first { $0.id == themeId } ?? themes.first { $0.id == "scratchpad" }!
