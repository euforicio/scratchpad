...
private let log = Logger(subsystem: "io.euforic.scratchpad", category: "UpdateChecker")
...
enum UpdateChecker {
    ...
    static func check() {
        let url = URL(string: "https://api.github.com/repos/euforicio/scratchpad/releases/latest")!
    ...
    private static func showUpdateAvailable(version: String, url: String) {
        ...
        alert.informativeText = String(localized: "update.available.message", defaultValue: "A new version of Scratchpad is available.")
    ...
    private static func showUpToDate(version: String) {
        ...
        alert.informativeText = String(localized: "update.up_to_date.message", defaultValue: "Scratchpad \(version) is the latest version.")
        alert.alertStyle = .informational
