...
class MenuBuilder {
    ...
    func buildAppMenuItem() -> NSMenuItem {
        ...
        let aboutItem = NSMenuItem(title: String(localized: "menu.app.about", defaultValue: "About Scratchpad"), action: #selector(NSApplication.orderFrontStandardAboutPanel(_:)), keyEquivalent: "")
        ...
        let hideItem = NSMenuItem(title: String(localized: "menu.app.hide", defaultValue: "Hide Scratchpad"), action: #selector(NSApplication.hide(_:)), keyEquivalent: "h")
        ...
        let quitItem = NSMenuItem(title: String(localized: "menu.app.quit", defaultValue: "Quit Scratchpad"), action: #selector(NSApplication.terminate(_:)), keyEquivalent: "q")
    ...
    func buildEditMenuItem() -> NSMenuItem {
        ...
        let toggleVimModeItem = NSMenuItem(title: String(localized: "menu.edit.toggle_vim_mode", defaultValue: "Toggle Vim mode"), action: #selector(AppDelegate.toggleVimModeAction), keyEquivalent: "")
        toggleVimModeItem.image = NSImage(systemSymbolName: "keyboard", accessibilityDescription: nil)
        toggleVimModeItem.target = target
        menu.addItem(toggleVimModeItem)
    ...
    func buildHelpMenuItem() -> NSMenuItem {
        ...
        let websiteItem = NSMenuItem(title: String(localized: "menu.help.website", defaultValue: "Scratchpad website"), action: #selector(AppDelegate.openHelpURL(_:)), keyEquivalent: "")
        websiteItem.image = NSImage(systemSymbolName: "globe", accessibilityDescription: nil)
        websiteItem.representedObject = websiteURL
