...
class AppDelegate: NSObject, NSApplicationDelegate, NSMenuItemValidation, NSToolbarDelegate, NSMenuDelegate {
    ...
    private func showMenu() {
        ...
        let toggleTitle = windowIsActive
            ? String(localized: "statusbar.hide", defaultValue: "Hide Scratchpad")
            : String(localized: "statusbar.show", defaultValue: "Show Scratchpad")
        let toggleIcon = windowIsActive ? "macwindow.badge.minus" : "macwindow"
        let showItem = NSMenuItem(title: toggleTitle, action: #selector(showScratchpad), keyEquivalent: "")
        ...
        let quitItem = NSMenuItem(title: String(localized: "statusbar.quit", defaultValue: "Quit Scratchpad"), action: #selector(quitApp), keyEquivalent: "q")
    ...
    @objc func openSettings() {
        ...
        window.title = String(localized: "settings.title", defaultValue: "Scratchpad settings")
    ...
    @objc func toggleVimModeAction() {
        SettingsStore.shared.isVimModeEnabled.toggle()
    }
    ...
    func validateMenuItem(_ menuItem: NSMenuItem) -> Bool {
        ...
        if menuItem.action == #selector(toggleVimModeAction) {
            menuItem.state = SettingsStore.shared.isVimModeEnabled ? .on : .off
        }
