        ...
        Form {
            Section {
                ...
                ShortcutRecorderView(
                    label: String(localized: "settings.general.show_scratchpad", defaultValue: "Show Scratchpad"),
                ...
                Toggle(
                    String(localized: "settings.general.show_only_in_menu_bar", defaultValue: "Show only in menu bar"),
                    isOn: Binding(
                        get: { store.showOnlyInMenuBar },
                        set: { store.showOnlyInMenuBar = $0 }
                    )
                )
    ...
    var body: some View {
        Form {
            Section {
                ...
                Toggle(String(localized: "settings.editor.vim_mode", defaultValue: "Enable Vim mode"), isOn: $store.isVimModeEnabled)
